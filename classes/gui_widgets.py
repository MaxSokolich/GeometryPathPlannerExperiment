...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.VideoFeedLabel.setGeometry(QtCore.QRect(-10, 30, 1041, 801))
...
"            }")
        ...
        self.apply_static_button = QtWidgets.QPushButton(self.frame_3)
        self.apply_static_button.setGeometry(QtCore.QRect(10, 100, 141, 31))
        self.apply_static_button.setCursor(QtGui.QCursor(QtCore.Qt.ArrowCursor))
        self.apply_static_button.setStyleSheet("\n"
"QPushButton {\n"
"                color: rgb(255, 255, 255);\n"
"                background-color: rgb(0, 0, 255);\n"
"                border-style: outset;\n"
...
"                padding-top: 5px;\n"
"            }")
        self.apply_static_button.setCheckable(True)
        self.apply_static_button.setObjectName("apply_static_button")
        self.generatepathbutton = QtWidgets.QPushButton(self.frame_3)
        self.generatepathbutton.setGeometry(QtCore.QRect(10, 60, 141, 31))
...
"            }")
        ...
        self.choosevideobutton.setGeometry(QtCore.QRect(190, 140, 111, 31))
...
"            }")
        ...
        self.numobstaclelabel_2 = QtWidgets.QLabel(self.frame_3)
        self.numobstaclelabel_2.setGeometry(QtCore.QRect(30, 35, 101, 20))
        self.numobstaclelabel_2.setMaximumSize(QtCore.QSize(150, 25))
        self.numobstaclelabel_2.setObjectName("numobstaclelabel_2")
        self.numobstaclelabel_3 = QtWidgets.QLabel(self.frame_3)
        self.numobstaclelabel_3.setGeometry(QtCore.QRect(190, 40, 101, 20))
        self.numobstaclelabel_3.setMaximumSize(QtCore.QSize(150, 25))
        self.numobstaclelabel_3.setObjectName("numobstaclelabel_3")
        self.apply_dynamic_button = QtWidgets.QPushButton(self.frame_3)
        self.apply_dynamic_button.setGeometry(QtCore.QRect(160, 80, 141, 31))
        self.apply_dynamic_button.setCursor(QtGui.QCursor(QtCore.Qt.ArrowCursor))
        self.apply_dynamic_button.setStyleSheet("\n"
"QPushButton {\n"
"                color: rgb(255, 255, 255);\n"
"                background-color: rgb(0, 0, 255);\n"
"                border-style: outset;\n"
...
"                padding-top: 5px;\n"
"            }")
        self.apply_dynamic_button.setCheckable(True)
        self.apply_dynamic_button.setObjectName("apply_dynamic_button")
...
"            }")
        ...
        self.croppedrecordbutton.setMinimumSize(QtCore.QSize(25, 0))
...
"            }")
        ...
        self.trackerparamsframe_2 = QtWidgets.QFrame(self.dockWidgetContents)
        self.trackerparamsframe_2.setGeometry(QtCore.QRect(10, 250, 311, 361))
        self.trackerparamsframe_2.setStyleSheet(" color: rgb(0, 0, 0);\n"
" background-color: rgb(255, 255, 255);\n"
"")
        self.trackerparamsframe_2.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.trackerparamsframe_2.setFrameShadow(QtWidgets.QFrame.Raised)
        self.trackerparamsframe_2.setObjectName("trackerparamsframe_2")
        self.robotmasklowerbox = QtWidgets.QSpinBox(self.trackerparamsframe_2)
        ...
        self.maskthreshlabel_3 = QtWidgets.QLabel(self.trackerparamsframe_2)
        self.maskthreshlabel_3.setGeometry(QtCore.QRect(10, 170, 81, 25))
        self.maskthreshlabel_3.setMaximumSize(QtCore.QSize(150, 25))
        self.maskthreshlabel_3.setObjectName("maskthreshlabel_3")
        self.robotmaskdilationbox = QtWidgets.QSpinBox(self.trackerparamsframe_2)
        ...
        self.maskdilationlabel_2 = QtWidgets.QLabel(self.trackerparamsframe_2)
        self.maskdilationlabel_2.setGeometry(QtCore.QRect(10, 250, 81, 25))
        self.maskdilationlabel_2.setMaximumSize(QtCore.QSize(150, 25))
        self.maskdilationlabel_2.setObjectName("maskdilationlabel_2")
        self.robotcroplengthbox = QtWidgets.QSpinBox(self.trackerparamsframe_2)
        ...
        self.croplengthlabel_2 = QtWidgets.QLabel(self.trackerparamsframe_2)
        self.croplengthlabel_2.setGeometry(QtCore.QRect(10, 90, 81, 25))
        self.croplengthlabel_2.setMaximumSize(QtCore.QSize(150, 25))
        self.croplengthlabel_2.setObjectName("croplengthlabel_2")
        self.robotmaskblurbox = QtWidgets.QSpinBox(self.trackerparamsframe_2)
        ...
        self.maskblurlabel_2 = QtWidgets.QLabel(self.trackerparamsframe_2)
        self.maskblurlabel_2.setGeometry(QtCore.QRect(10, 130, 61, 25))
        self.maskblurlabel_2.setMaximumSize(QtCore.QSize(150, 25))
        self.maskblurlabel_2.setObjectName("maskblurlabel_2")
        self.maskbutton = QtWidgets.QPushButton(self.trackerparamsframe_2)
...
"            }")
        ...
        self.robotmask_radio = QtWidgets.QRadioButton(self.trackerparamsframe_2)
        ...
        self.cellmask_radio = QtWidgets.QRadioButton(self.trackerparamsframe_2)
        self.cellmask_radio.setGeometry(QtCore.QRect(220, 50, 81, 30))
        self.cellmask_radio.setObjectName("cellmask_radio")
        self.maskinvert_checkBox = QtWidgets.QCheckBox(self.trackerparamsframe_2)
        ...
        self.cellmaskblurbox = QtWidgets.QSpinBox(self.trackerparamsframe_2)
        ...
        self.cellmasklowerbox = QtWidgets.QSpinBox(self.trackerparamsframe_2)
        ...
        self.cellmaskdilationbox = QtWidgets.QSpinBox(self.trackerparamsframe_2)
        ...
        self.cellcroplengthbox = QtWidgets.QSpinBox(self.trackerparamsframe_2)
        ...
        self.cellmaskupperbox = QtWidgets.QSpinBox(self.trackerparamsframe_2)
        ...
        self.maskthreshlabel_4 = QtWidgets.QLabel(self.trackerparamsframe_2)
        self.maskthreshlabel_4.setGeometry(QtCore.QRect(10, 210, 81, 25))
        self.maskthreshlabel_4.setMaximumSize(QtCore.QSize(150, 25))
        self.maskthreshlabel_4.setObjectName("maskthreshlabel_4")
        self.safteyradius = QtWidgets.QLabel(self.trackerparamsframe_2)
        self.safteyradius.setGeometry(QtCore.QRect(10, 290, 81, 25))
        self.safteyradius.setMaximumSize(QtCore.QSize(150, 25))
        self.safteyradius.setObjectName("safteyradius")
        self.safetyradiusbox = QtWidgets.QDoubleSpinBox(self.trackerparamsframe_2)
        self.safetyradiusbox.setGeometry(QtCore.QRect(110, 290, 61, 22))
        self.safetyradiusbox.setMinimum(0.1)
        self.safetyradiusbox.setMaximum(50.0)
        self.safetyradiusbox.setSingleStep(0.1)
        self.safetyradiusbox.setProperty("value", 0.5)
        self.safetyradiusbox.setObjectName("safetyradiusbox")
        self.alphabox = QtWidgets.QSpinBox(self.trackerparamsframe_2)
        self.alphabox.setGeometry(QtCore.QRect(110, 320, 61, 21))
        self.alphabox.setMinimum(1)
        self.alphabox.setMaximum(20)
        self.alphabox.setSingleStep(1)
        self.alphabox.setProperty("value", 6)
        self.alphabox.setDisplayIntegerBase(10)
        self.alphabox.setObjectName("alphabox")
        self.alpha = QtWidgets.QLabel(self.trackerparamsframe_2)
        self.alpha.setGeometry(QtCore.QRect(10, 315, 81, 25))
        self.alpha.setMaximumSize(QtCore.QSize(150, 25))
        self.alpha.setObjectName("alpha")
        self.frequency_label = QtWidgets.QLabel(self.trackerparamsframe_2)
        self.frequency_label.setGeometry(QtCore.QRect(210, 290, 81, 25))
        self.frequency_label.setMaximumSize(QtCore.QSize(150, 25))
        self.frequency_label.setObjectName("frequency_label")
        self.frequency_box = QtWidgets.QSpinBox(self.trackerparamsframe_2)
        self.frequency_box.setGeometry(QtCore.QRect(210, 310, 61, 35))
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(False)
        font.setItalic(False)
        ...
        self.frequency_box.setMaximum(200)
        self.frequency_box.setSingleStep(1)
        self.frequency_box.setProperty("value", 10)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.apply_static_button.setText(_translate("MainWindow", "Apply Static"))
        ...
        self.numobstaclelabel_2.setText(_translate("MainWindow", "Static"))
        self.numobstaclelabel_3.setText(_translate("MainWindow", "Dynamic"))
        self.apply_dynamic_button.setText(_translate("MainWindow", "Apply Dynamic"))
        ...
        self.maskthreshlabel_3.setText(_translate("MainWindow", "Lower Thresh"))
        self.maskdilationlabel_2.setText(_translate("MainWindow", "Dilation"))
        self.croplengthlabel_2.setText(_translate("MainWindow", "Crop Length"))
        self.maskblurlabel_2.setText(_translate("MainWindow", "Blur"))
        ...
        self.maskthreshlabel_4.setText(_translate("MainWindow", "Upper Thresh"))
