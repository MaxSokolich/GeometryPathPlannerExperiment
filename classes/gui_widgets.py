...
"")
        ...
        self.robotmasklowerbox.setGeometry(QtCore.QRect(110, 195, 91, 20))
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(False)
        font.setItalic(False)
        ...
        self.robotmaskdilationbox.setGeometry(QtCore.QRect(110, 255, 91, 20))
        ...
        self.robotcroplengthbox.setGeometry(QtCore.QRect(110, 135, 91, 21))
        ...
        self.robotmaskblurbox.setGeometry(QtCore.QRect(110, 165, 91, 21))
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(False)
        font.setItalic(False)
...
"            }")
        ...
        self.robotmaskupperbox.setGeometry(QtCore.QRect(110, 225, 91, 21))
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(False)
        font.setItalic(False)
        ...
        self.numobstaclesbox = QtWidgets.QSpinBox(self.trackerparamsframe)
        self.numobstaclesbox.setGeometry(QtCore.QRect(110, 40, 91, 21))
        self.numobstaclesbox.setMinimum(1)
        self.numobstaclesbox.setMaximum(100)
        self.numobstaclesbox.setSingleStep(1)
        self.numobstaclesbox.setProperty("value", 10)
        self.numobstaclesbox.setDisplayIntegerBase(10)
        self.numobstaclesbox.setObjectName("numobstaclesbox")
        self.numobstaclelabel = QtWidgets.QLabel(self.trackerparamsframe)
        self.numobstaclelabel.setGeometry(QtCore.QRect(10, 40, 81, 25))
        ...
        self.safteyradius.setGeometry(QtCore.QRect(10, 70, 81, 25))
        ...
        self.alphabox.setGeometry(QtCore.QRect(110, 105, 91, 21))
        ...
        self.alpha.setGeometry(QtCore.QRect(10, 100, 81, 25))
        ...
        self.safetyradiusbox.setGeometry(QtCore.QRect(110, 70, 91, 22))
...
"            }")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.numobstaclelabel.setText(_translate("MainWindow", "Num Obstacles"))
